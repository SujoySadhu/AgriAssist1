...
// // //                 timer: 1500
// // //             }).then(() => {
// // //                 // Only navigate to post detail if status is Active
// // //                 if (post.status === "Active") {
// // //                     navigate(`/post/${response.data.slug}/`);
// // //                 } else {
// // //                     navigate("/author/dashboard/posts/");
// // //                 }
// // //             });
// // //         } catch (error) {
// // //             console.error("Error creating post:", error);
...
//             Swal.fire({
//                 icon: "error",
//                 title: t('postCreateFailed'),
//                 text: error.response?.data?.message || t('unexpectedError'),
//             });
//         } finally {
//             setIsLoading(false);
//         }
...
//                                 <div className="d-flex justify-content-between align-items-center mb-4">
//                                     <div>
//                                         <h1 className="mb-0">{t('createNewPost')}</h1>
//                                         <p className="mb-0 text-muted">{t('fillFormToPublish')}</p>
//                                     </div>
//                                     <Link to="/posts/" className="btn btn-light">
//                                         <i className="fas fa-arrow-left me-2"></i>{t('backToPosts')}
//                                     </Link>
//                                 </div>
//                             </div>
//                         </div>
...
//                                     <div className="card shadow-sm mb-4">
//                                         <div className="card-header">
//                                             <h5 className="mb-0">{t('postContent')}</h5>
//                                         </div>
//                                         <div className="card-body">
//                                             <div className="mb-3">
...
//                                                     className="form-control"
//                                                     rows="8"
//                                                     placeholder={t('writeArticlePlaceholder')}
//                                                     required
//                                                 ></textarea>
//                                             </div>
//                                         </div>
...
//                                     <div className="card shadow-sm mb-4">
//                                         <div className="card-header">
//                                             <h5 className="mb-0">{t('featuredImage')}</h5>
//                                         </div>
//                                         <div className="card-body">
//                                             <label htmlFor="postThumbnail" className="form-label">
//                                                 {t('uploadThumbnail')}
...
//                                     <div className="card shadow-sm mb-4">
//                                         <div className="card-header">
//                                             <h5 className="mb-0">{t('imageGallery')}</h5>
//                                         </div>
//                                         <div className="card-body">
//                                             <p className="text-muted small">{t('galleryDescription')}</p>
//                                             <button
//                                                 type="button"
//                                                 className="btn btn-outline-primary"
//                                                 onClick={() => additionalImagesInputRef.current.click()}
//                                             >
//                                                 <i className="fas fa-plus me-2"></i>{t('addImages')}
//                                             </button>
//                                             <input
//                                                 type="file"
//                                                 multiple
...
//                                                                 <img 
//                                                                     src={preview} 
//                                                                     alt={t('galleryPreviewAlt', { num: index + 1 })} 
//                                                                     className="img-fluid rounded" 
...
//                                     <div className="card shadow-sm mb-4">
//                                         <div className="card-header">
//                                             <h5 className="mb-0">{t('organization')}</h5>
//                                         </div>
//                                         <div className="card-body">
//                                             <div className="mb-3">
//                                                 <label htmlFor="category" className="form-label">{t('categoryLabel')}</label>
//                                                 <select 
//                                                     name="category" 
//                                                     id="category" 
//                                                     onChange={handleCreatePostChange} 
...
//                                             {/* Tag Input */}
//                                             <div className="mb-3">
//                                                 <label htmlFor="tags" className="form-label">{t('tagsLabel')}</label>
//                                                 <div className="form-control" style={{ height: 'auto' }}>
//                                                     {tags.map((tag, index) => (
//                                                         <span key={index} className="badge bg-secondary me-2 mb-1">
//                                                             {tag}
...
//                                                     />
//                                                 </div>
//                                                 <div className="form-text">{t('tagsHint')}</div>
//                                             </div>
                                            
//                                             <div>
//                                                 <label htmlFor="status" className="form-label">{t('statusLabel')}</label>
//                                                 <select 
//                                                     name="status" 
//                                                     id="status" 
//                                                     onChange={handleCreatePostChange} 
...
//                                                     required
//                                                 >
//                                                     <option value="Active">{t('publish')}</option>
//                                                     <option value="Draft">{t('saveAsDraft')}</option>
//                                                 </select>
//                                                 <div className="form-text">
//                                                     {t('draftNotice')}
//                                                 </div>
...
//                                         <button className="btn btn-primary btn-lg" type="submit" disabled={isLoading}>
//                                             {isLoading ? (
//                                                 <span><i className="fas fa-spinner fa-spin me-2"></i>{t('creatingPost')}</span>
//                                             ) : (
//                                                 <span><i className="fas fa-check-circle me-2"></i>{t('createPostButton')}</span>
//                                             )}
//                                         </button>
//                                     </div>
//                                 </form>
                            ...
                            <div className="col-lg-8">
                                <form onSubmit={handleCreatePost}>
                                        ...
                                        <div className="card-body">
                                            <div className="mb-3">
                                                <label htmlFor="title" className="form-label">
                                                    {t('postTitle')} {errors.title && <span className="text-danger">*</span>}
                                                </label>
                                                <input
                                                    onChange={handleCreatePostChange}
                                                    name="title"
                                                    ...
                                                    required
                                                />
                                                {errors.title && <div className="invalid-feedback">{t('titleRequired')}</div>}
                                            </div>
                                            <div className="mb-3">
                                                <label htmlFor="description" className="form-label">
                                                    {t('descriptionLabel')} {errors.description && <span className="text-danger">*</span>}
                                                </label>
                                                <textarea
                                                    onChange={handleCreatePostChange}
                                                    name="description"
                                                    ...
                                                    required
                                                ></textarea>
                                                {errors.description && <div className="invalid-feedback">{t('descriptionRequired')}</div>}
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="card shadow-sm mb-4">
                                        ...
                                        <div className="card-body">
                                            <label htmlFor="postThumbnail" className="form-label">
                                                {t('uploadThumbnail')} {errors.image && <span className="text-danger">*</span>}
                                            </label>
                                            <input
                                                onChange={handleFileChange}
                                                name="file"
                                                ...
                                                required
                                            />
                                            {errors.image && <div className="invalid-feedback">{t('imageRequired')}</div>}
                                            {imagePreview && (
                                                <div className="mt-3">
                                                    <img
                                                        src={imagePreview}
                                        ...
                                        <div className="card-body">
                                            <div className="mb-3">
                                                <label htmlFor="category" className="form-label">
                                                    {t('categoryLabel')} {errors.category && <span className="text-danger">*</span>}
                                                </label>
                                                <select 
                                                    name="category" 
                                                    id="category" 
                                                ...
                                                {errors.category && <div className="invalid-feedback">{t('categoryRequired')}</div>}
                                            </div>
                                            ...
                                            <div>
                                                <label htmlFor="status" className="form-label">
                                                    {t('statusLabel')} {errors.status && <span className="text-danger">*</span>}
                                                </label>
                                                <select 
                                                    name="status" 
                                                    id="status" 
                                                ...
                                                {errors.status && <div className="invalid-feedback">{t('statusRequired')}</div>}
